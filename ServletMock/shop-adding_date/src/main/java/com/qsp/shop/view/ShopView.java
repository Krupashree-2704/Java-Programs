		...
		do {
			...
			case 1:
				...
				if (productsCount==1) {
					...
					System.out.println("Enter Product's Manufacturing Date : ");
					Date manufacturing=Date.valueOf(myInput.next());
					System.out.println("Enter Product's Expiry Date : ");
					Date expiry=Date.valueOf(myInput.next());
					if((shopController.addRecords(i_p_id,i_p_name,i_p_price,i_p_quantity,i_p_availability,manufacturing,expiry))!=0)		
					{
