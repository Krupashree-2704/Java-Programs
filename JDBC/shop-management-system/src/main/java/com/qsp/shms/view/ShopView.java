...
import com.qsp.shms.controller.ShopController;
import com.qsp.shms.model.Product;
...
//				System.out.println(fetchProduct);//if true,false resultSet tayar hoga,address rahega
				...
				try {
					...
					if (next) {
						...
						System.out.println("Product with given ID does not exists.");
					}
